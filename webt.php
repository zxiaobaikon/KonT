 ...
 * 开源版服务器文件管理 & 系统监控面板
 * 
 * 警告：本工具移除了所有登录验证，请勿暴露在公网环境！
 * 建议仅在内网或本地开发环境使用。
 * 
 * 配置：修改下方的 $ROOT_PATH 变量，指向您要管理的根目录。
 */

// ============ 配置 ============
// 请修改为您需要管理的目录绝对路径，例如：'/var/www/html' 或 __DIR__
$ROOT_PATH = __DIR__;  // 默认使用当前脚本所在目录
...
<div class="editor-overlay" id="editorOverlay">
    ...
    <div class="editor-main">
        ...
        <div class="editor-pop-panel search-panel" id="searchPanel">
            <div class="panel-row">
        ...
        <div class="editor-pop-panel replace-panel" id="replacePanel">
            <div class="panel-row">
                <input type="text" id="replaceSearchInput" placeholder="查找内容...">
                <button class="close-search-btn" id="closeReplaceBtn" title="关闭替换">✕</button>
            </div>
            <div class="panel-row">
                <input type="text" id="replaceInput" placeholder="替换为...">
            </div>
            <div class="panel-actions">
                <button class="action-btn" id="replaceOneBtn">替换下一个</button>
                <button class="action-btn" id="replaceAllBtn">全部替换</button>
            </div>
            <div class="search-info">
                <span class="match-count" id="replaceMatchCount">0 个匹配</span>
                <span style="color:#858585;">回车替换下一个</span>
            </div>
        </div>
        <div class="editor-pop-panel goto-panel" id="gotoPanel">
            <div class="panel-row">
                <input type="number" id="gotoLineInput" min="1" placeholder="输入行号...">
                <button class="close-search-btn" id="closeGotoBtn" title="关闭跳转">✕</button>
            </div>
            <div class="panel-actions">
                <button class="action-btn" id="gotoLineConfirmBtn">跳转</button>
            </div>
            <div class="search-info">
                <span id="gotoLineHint">支持输入行号后回车</span>
            </div>
        </div>
        <div class="editor-statusbar">
            <div class="status-left">
                <span class="status-path" id="statusFilePath">文件位置: 无</span>
